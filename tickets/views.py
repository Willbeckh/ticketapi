...
class UserViewSet(viewsets.ModelViewSet):
    """Provides HTTP methods to retrive, update, soft delete a user object."""
...
class TicketViewSet(viewsets.ModelViewSet):
    """Provides HTTP methods to retrive, update, soft delete a ticket object."""
...
class CategoryViewSet(viewsets.ModelViewSet):
    """Provides HTTP methods to retrive, update, soft delete a category object."""
